      ...
      "blocks": [
          ...
          "entries": [
            {
              ...
              "current": false,
              "bullets": [
                "시장 규모 추정, 이슈 트리 분석, 가설 기반 문제 해결, 고객 커뮤니케이션 프레임워크 등 컨설팅 기초를 다루는 10주 과정의 선발형 부트캠프에 참여했습니다.",
                "다섯 차례의 모의 컨설팅 면접에 참여하고 4인 팀으로 구조화된 제안과 발표를 수행하여 분석의 엄밀함과 명확한 커뮤니케이션으로 인정을 받았습니다."
              ],
              "_id": "ak200c"
            },
            {
              ...
              "current": false,
              "bullets": [
                "DCF 모델, 유사기업 비교 분석, EDGAR 데이터를 활용해 밸류에이션 리포트와 산업 브리프를 작성하고 투자위원회에 매수/매도 의견을 발표했습니다.",
                "100만 달러 규모의 모의 포트폴리오를 운용하며 섹터 로테이션 분석과 상대강도 스크리닝으로 보고 기간 동안 35%의 수익을 달성했습니다."
              ],
              "_id": "ak200d"
            }
          ]
        },
        {
          ...
          "rows": [
            {
              "name": "Blackjack RL",
              "text": "Gymnasium 환경에서 구축한 Q-learning 에이전트. 모델이 환경과 상호작용하는 과정을 시각화하는 GUI를 통합했습니다.",
              "tag": "Python",
              "_id": "ak200e"
            },
            {
              "name": "Chess AI",
              "text": "평가 함수와 알파-베타 가지치기를 적용한 미니맥스 알고리즘으로 수 선택을 개선했습니다.",
              "tag": "Python",
              "_id": "ak200f"
            },
            {
              "name": "Airbnb Pricing",
              "text": "회귀 분석과 단계적 모델 선택으로 사회경제 데이터셋에서 임대 가격 결정 요인을 분석했습니다.",
              "tag": "R",
              "_id": "ak200g"
            }
          ]
          ...
          "entries": [
            {
              ...
              "bullets": [
                ...
                "**통계학.** 회귀 분석, 모델 선택, R을 활용한 응용 데이터 분석. Airbnb 가격 분석 프로젝트와 RLWRLD의 실행 가능성 평가 프레임워크의 토대가 되었습니다.",
                "**응용 AI.** 강화학습(Gymnasium 기반 Q-learning)과 적대적 탐색(알파-베타 가지치기를 적용한 미니맥스)을 독립 프로젝트로 구현했습니다."
              ],
              "_id": "ak200l"
            },
            {
          ...
          "entries": [
            {
              ...
              "current": true,
              "bullets": [
                "군 복무 중 약 21개월 동안 비근무 시간을 활용해 독학으로 CFA 시험 2개 레벨에 응시했습니다.",
    ...
    },
    {
      ...
      "blocks": [
          ...
          "cards": [
            {
              "meta": "트라이애슬론",
              "title": "아이언맨 70.3",
              "text": "하프 거리 트라이애슬론. 세 종목, 하나의 기록, 그리고 페이스 판단이 이어지는 긴 하루.",
              "facts": [
                {
                  "label": "수영",
                  "value": "1.9 km",
            ...
            },
            {
              "meta": "러닝",
              "title": "마라톤",
              "text": "체력만으로는 부족하고, 보급과 네거티브 스플릿이 더 중요해지는 거리.",
              "facts": [
                {
                  "label": "거리",
                  "value": "42.195 km",
            ...
            },
            {
              "meta": "트레일 & 로드",
              "title": "울트라마라톤",
              "text": "마라톤을 넘어서는 모든 거리. 50 km와 100 km 종목에 출전하며, 목표가 속도에서 몇 시간 동안 꾸준함을 유지하는 것으로 바뀝니다.",
              "facts": [
                {
                  "label": "거리",
                  "value": "50 km · 100 km",
            ...
            },
            {
              "meta": "피트니스 레이싱",
              "title": "하이록스",
              "text": "1 km 러닝 8회, 매 구간 뒤에 워크아웃 스테이션: 스키에르그, 슬레드 푸시와 풀, 버피 브로드 점프, 로잉, 파머스 캐리, 샌드백 런지, 월볼.",
              "facts": [
                {
                  "label": "형식",
                  "value": "8 × 1 km + 8 스테이션",
        ...
        },
        {
          ...
          "title": "포커",
          "paragraphs": [
            "코스 밖에서는 포커를 칩니다. 주로 수학 때문입니다. 팟 오즈, 기대값, 불완전한 정보를 읽는 능력은 밸류에이션에서, 그리고 로봇 도입이 계약할 만한 가치가 있는지 판단할 때 똑같이 쓰이는 기술입니다."
          ]
        },
        {
          "type": "posts",
