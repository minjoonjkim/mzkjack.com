          ...
          "entries": [
            {
              ...
              "current": false,
              "bullets": [
                "시장 규모 추정, 이슈 트리 분석, 가설 기반 문제 해결, 고객 커뮤니케이션 프레임워크 등 컨설팅 기초를 다루는 10주 과정 선발형 부트캠프 참여 및 수료 완료"
              ],
              "_id": "ak200c"
            },
            {
              ...
              "current": false,
              "bullets": [
                "DCF 모델, 유사기업 비교 분석, EDGAR 데이터를 활용한 밸류에이션 리포트와 산업 Weekly 브리핑 자료 작성, 투자위원회에 매수·매도 의견 발표",
                "100M USD 모의  포트폴리오 운용, 섹터 로테이션 분석과 상대강도 스크리닝으로 보고 기간 35% 수익 달성"
              ],
              "_id": "ak200d"
            }
          ]
