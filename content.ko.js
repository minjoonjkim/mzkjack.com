      ...
      "blocks": [
        {
          ...
          "title": "소개",
          "paragraphs": [
            "한국에서 태어나 홍콩에서 어린 시절을 보냈고, 이후 남아프리카공화국으로 이주해 펜실베이니아 주립대학교에서 컴퓨터과학과 통계학을 공부하기 전까지 그곳에서 살았습니다.",
            "대한민국 병역을 마친 뒤, 갭이어를 가지고 RLWRLD에서 로보틱스 트랜스포메이션 컨설턴트로 인턴을 하고 있습니다. RLWRLD는 로보틱스를 위한 실세계 지능(real-world intelligence)을 만드는 회사이며, 저희 팀은 다양한 산업의 고객과 함께 현장 운영을 이해하고 로봇과 피지컬 AI를 실제 현장에 도입하기 위한 맞춤 전략을 수립합니다.",
            "일 밖에서는 지구력 스포츠가 삶의 큰 부분을 차지합니다. 울트라마라톤을 포함한 러닝을 즐기고, 현재는 아이언맨을 목표로 훈련하고 있습니다.",
            "뜻이 있는 곳에 길이 있다고 굳게 믿으며, 이 마음가짐이 일과 개인적인 목표에 접근하는 방식을 만들어 갑니다."
          ]
        },
        {
          "type": "entries",
