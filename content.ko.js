/* Korean site content. Edit this file directly, or use admin.html (password protected)
      ...
      "blocks": [
        {
          ...
          "title": "소개",
          "paragraphs": [
            "저는 한국에서 태어나 홍콩에서 어린 시절을 보냈고, 이후 남아프리카공화국으로 이주해 오랜 시간을 살았습니다. 서로 다른 문화와 환경을 경험하며 자연스럽게 새로운 상황에 적응하고, 다양한 관점에서 사람과 문제를 바라보는 법을 배웠습니다. 이후 미국으로 건너가 펜실베이니아 주립대학교에서 컴퓨터과학을 전공하고 통계학을 부전공하며, 복잡한 문제를 논리적으로 구조화하고 데이터와 기술을 통해 해결하는 방법을 공부하고 있습니다.",
            "군대를 마친 뒤에는 잠시 학교를 떠나 실제 산업 현장을 경험해 보고자 갭이어를 선택했습니다. 현재는 피지컬 AI 스타트업 RLWRLD에서 로보틱스 트랜스포메이션 컨설턴트 인턴으로 일하고 있습니다. RLWRLD는 로봇이 현실 세계를 이해하고 행동하는 데 필요한 실세계 지능을 개발하는 회사입니다. 제가 속한 팀은 제조, 물류, 호텔을 비롯한 다양한 산업 현장의 운영 방식과 자동화 수요를 분석하고, 로봇과 피지컬 AI를 실제 업무에 도입하기 위한 전략과 실행 방안을 설계합니다.",
            "저는 이곳에서 기술과 비즈니스 사이를 연결하는 역할을 맡고 있습니다. 고객의 현장을 직접 살펴보고 로봇이 해결할 수 있는 작업을 발굴하는 것부터, 로봇의 배포 가능성을 평가하는 프레임워크와 데이터 플랫폼을 직접 개발하는 일까지 폭넓게 경험하고 있습니다. 기술적으로 가능한 것과 현장에서 실제로 가치가 있는 것은 항상 같지 않다는 점을 배우며, 좋은 기술을 만드는 것만큼 그것이 어디에서 어떻게 사용되어야 하는지를 판단하는 일도 중요하다는 사실을 체감하고 있습니다.",
            "일 밖에서는 지구력 스포츠가 제 삶의 큰 부분을 차지합니다. 러닝과 울트라마라톤을 즐기며, 현재는 아이언맨 완주를 목표로 수영, 사이클, 러닝을 함께 훈련하고 있습니다. 지구력 스포츠는 단순한 취미를 넘어, 긴 시간 동안 페이스를 조절하고 예상하지 못한 어려움 속에서도 계속 앞으로 나아가는 법을 가르쳐 주었습니다.",
            "저는 “Where there’s a will, there’s a way”라는 문장을 삶의 모토로 삼고 있습니다. 처음부터 명확한 답이나 길이 보이지 않더라도 의지가 분명하다면 끊임없는 시도와 꾸준한 실행을 통해 결국 길을 만들어 갈 수 있다고 믿습니다. 이 믿음은 새로운 환경에 도전하는 자세와 업무에서 복잡한 문제를 해결하는 방식, 그리고 개인적인 목표를 향해 나아가는 태도의 바탕이 되고 있습니다."
          ]
        },
        {
          "type": "entries",
          ...
          "entries": [
            {
              ...
              "current": true,
              "bullets": [
                "럭셔리 호텔 그룹의 운영 업무 흐름을 로봇 도입 모델로 재구성, 수백 개 세부 업무의 자동화 타당성을 평가해 인력 수용량과 로봇 대수 요건, 도입 논거 산정",
                "호스피탈리티·제조·물류 3개 산업의 고객 제안서와 경영진 발표자료 구조화, 로봇 기술 역량과 도입 경제성을 의사결정권자용 비즈니스 케이스로 구성",
                "AI 기반 자동화 평가 툴을 기획부터 상품화까지 전 과정 주도, 현장 영상 한 편으로 준비도 판정을 산출하는 근거 기반 평가 기준 수립",
                "해당 제품의 VLM Ops 파이프라인 구축, 평가 루브릭과 버전 관리형 판정 로직, PostgreSQL 작업 오케스트레이션을 통합해 3종 영상 입력 소스의 평가 결과를 2개 언어로 제공",
                "로보틱스 데이터 플랫폼의 워크플로와 데이터베이스 스키마, 백엔드 서비스 개발, 6단계 처리 과정을 거쳐 원본 현장 영상을 구조화된 모델 학습 데이터로 가공"
              ],
              "_id": "ak2006"
            },
            {
              ...
              "current": false,
              "bullets": [
                "지하철 역사 관제 시스템 운영으로 승객 안전 확보, 비번 시간을 활용한 독학으로 CFA 2개 레벨 응시"
              ],
              "_id": "ak2008"
            }
          ]
        },
        {
          ...
          "entries": [
            {
              "heading": "어소시에이트 트레이니",
              "org": "Nittany Lion Consulting Group · 컨설팅 트레이닝 프로그램",
              "location": "미국 펜실베이니아",
              "when": "2024년 1월 – 2024년 5월",
              "current": false,
              "bullets": [
                "시장 규모 추정, 이슈 트리 분석, 가설 기반 문제 해결, 고객 커뮤니케이션 프레임워크 등 컨설팅 기초를 다루는 10주 과정 선발형 부트캠프 참여",
                "모의 컨설팅 면접 5회 참여, 4인 팀으로 구조화된 제안과 발표를 수행해 분석의 엄밀함과 명확한 커뮤니케이션으로 인정"
              ],
              "_id": "ak200c"
            },
            {
              "heading": "IT·커뮤니케이션 부문 부회장",
              "org": "Penn State Capital College Student Investment Fund",
              "location": "미국 펜실베이니아",
              "when": "2021년 10월 – 2023년 5월",
              "current": false,
              "bullets": [
                "DCF 모델, 유사기업 비교 분석, EDGAR 데이터를 활용한 밸류에이션 리포트와 산업 브리프 작성, 투자위원회에 매수·매도 의견 발표",
                "100만 달러 규모 모의 포트폴리오 운용, 섹터 로테이션 분석과 상대강도 스크리닝으로 보고 기간 35% 수익 달성"
              ],
              "_id": "ak200d"
            }
          ]
        },
        {
          ...
          "rows": [
            {
              "name": "Blackjack RL",
              "text": "Gymnasium 환경에서 구축한 Q-learning 에이전트, 모델과 환경의 상호작용을 시각화하는 GUI 통합",
              "tag": "Python",
              "_id": "ak200e"
            },
            {
              "name": "Chess AI",
              "text": "평가 함수와 알파-베타 가지치기를 적용한 미니맥스 알고리즘으로 수 선택 개선",
              "tag": "Python",
              "_id": "ak200f"
            },
            {
              "name": "Airbnb Pricing",
              "text": "회귀 분석과 단계적 모델 선택으로 사회경제 데이터셋의 임대 가격 결정 요인 분석",
              "tag": "R",
              "_id": "ak200g"
            }
          ]
    ...
    },
    {
      ...
      "blocks": [
        ...
        },
        {
          ...
          "entries": [
            {
              "heading": "컴퓨터과학 학사, 통계학 부전공",
              "org": "펜실베이니아 주립대학교",
              "location": "",
              "when": "2021 – 2028",
              "current": true,
              "bullets": [
                "**컴퓨터과학.** 알고리즘, 자료구조, C/C++ 시스템 프로그래밍, Java와 C# 객체지향 설계, 데이터베이스와 SQL",
                "**통계학.** 회귀 분석, 모델 선택, R을 활용한 응용 데이터 분석, Airbnb 가격 분석 프로젝트와 RLWRLD 실행 가능성 평가 프레임워크의 토대",
                "**응용 AI.** 강화학습(Gymnasium 기반 Q-learning)과 적대적 탐색(알파-베타 가지치기를 적용한 미니맥스)을 독립 프로젝트로 구현"
              ],
              "_id": "ak200l"
            },
            {
          ...
          "entries": [
            {
              ...
              "current": true,
              "bullets": [
                "군 복무 중 약 21개월간 비근무 시간을 활용한 독학으로 CFA 시험 2개 레벨 응시",
                "업무에 적용하는 핵심 영역: 주식 밸류에이션, 재무제표 분석, 기업재무, 포트폴리오 관리"
              ],
              "_id": "ak200o"
            }
          ]
