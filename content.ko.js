      ...
      "blocks": [
        {
          ...
          "paragraphs": [
            ...
            "병역 자원입대를 마친 뒤에는 잠시 학교를 떠나 실제 산업 현장을 경험해 보고자 갭이어를 선택했습니다. 현재는 피지컬 AI 스타트업 RLWRLD에서 로보틱스 트랜스포메이션 컨설턴트 인턴으로 일하고 있습니다. RLWRLD는 로봇이 현실 세계를 이해하고 행동하는 데 필요한 실세계 지능을 개발하는 회사입니다. 제가 속한 팀은 제조, 물류, 호텔을 비롯한 다양한 산업 현장의 운영 방식과 자동화 수요를 분석하고, 로봇과 피지컬 AI를 실제 업무에 도입하기 위한 전략과 실행 방안을 설계합니다.",
            ...
            "일 밖에서는 지구력 스포츠가 제 삶의 큰 부분을 차지합니다. 로드 러닝과 울트라마라톤을 즐기며, 현재는 아이언맨 완주를 목표로 수영, 사이클, 러닝을 함께 훈련하고 있습니다. 지구력 스포츠는 단순한 취미를 넘어, 긴 시간 동안 페이스를 조절하고 예상하지 못한 어려움 속에서도 계속 앞으로 나아가는 법을 가르쳐 주었습니다.",
          ...
          "entries": [
            {
              ...
              "current": true,
              "bullets": [
                "AI 기반 자동화 평가 툴을 기획부터 상품화까지 전 과정 주도, 현장 영상 한 편으로 준비도 항목별 근거 기반 판정을 산출하는 평가 기준 수립",
                "VLM Ops 파이프라인 구축, 평가 루브릭과 버전 관리형 판정 로직, PostgreSQL 작업 오케스트레이션을 통합해 3종 영상 입력 소스의 평가 결과를 2개 언어로 제공",
                "로보틱스 데이터 플랫폼의 워크플로와 데이터베이스 스키마, 백엔드 서비스 개발, 6단계 처리 과정을 거쳐 원본 현장 영상을 구조화된 모델 학습 데이터로 가공",
                "럭셔리 호텔 그룹의 업무 흐름을 로봇 도입 모델로 재구성, 수백 개 세부 업무를 평가해 자동화 기회를 발굴하고 인력 수용량과 로봇 대수 요건 산정",
                "고객 제안서와 경영진 발표자료 작성, 로봇 기술 역량과 도입 경제성을 호스피탈리티·제조·물류 3개 산업의 비즈니스 케이스로 구체화"
              ],
              "_id": "ak2006"
            },
            {
              ...
              "current": false,
              "bullets": [
                "지하철 역사 전반의 관제 시스템 운영으로 안전 확보, 비번 시간을 활용한 독학으로 CFA 2개 레벨 응시"
              ],
              "_id": "ak2008"
            }
          ]
