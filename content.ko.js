          ...
          "entries": [
            {
              ...
              "current": true,
              "bullets": [
                "AI 평가 제품의 기획부터 고객 납품까지 전 과정 수행, 평가 기준을 정의해 현장 영상 한 편을 7개 준비도 항목의 근거 기반 판정으로 전환",
                "VLM Ops 파이프라인 구축, 평가 루브릭·버전 관리 판정 로직·PostgreSQL 작업 오케스트레이션을 통합해 3개 영상 입력 소스의 평가 결과를 2개 언어로 제공",
                "로보틱스 데이터 플랫폼의 워크플로·데이터베이스 스키마·백엔드 서비스 개발, 6단계 처리 과정을 통합해 원본 현장 영상을 구조화된 모델 학습 데이터로 전환",
                "럭셔리 호텔 그룹의 고객 업무 흐름을 로봇 도입 모델로 전환, 수백 개 세부 업무를 평가해 자동화 기회 발굴 및 인력 수용량·로봇 대수 요건 산정",
                "고객 제안서와 경영진 발표자료 작성, 로봇 기술 역량과 도입 경제성을 호스피탈리티·제조·물류 3개 산업의 비즈니스 케이스로 구성"
              ],
              "_id": "ak2006"
            },
            {
